@echo off
echo Last Update --> 10:26 PM 07/27/2021 Paul Stryer<--
set pod_min=1
set pod_max=20
set workdir=c:\Users\user\

rem Change into working directory
cd %workdir%
...
set /p password="Enter your pods vManage netadmin uesr password: "
...
@echo on
sdwan -a %ip% -u netadmin -p %password% --verbose backup all
@echo off

echo(
echo Files backed up to a folder in the %workdir%data directory.
echo(
